...
const AboutHero = ({ 
  ...
  // Stagger the left-column content in on mount. Because each business page
  // mounts its own AboutHero, this replays on every navigation — making the
  // switch between pages feel like a real transition, not just a text swap.
      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.h2
            ...
            className="text-lg md:text-xl font-bold text-secondary mb-4 uppercase tracking-widest opacity-90"
          >
            {subtitle}
          </motion.h2>
          <motion.h1
            variants={itemVariants}
            className="text-5xl md:text-6xl lg:text-7xl font-black text-white mb-8 uppercase tracking-tighter leading-[1.05] break-words"
          >
            {title === "ELEV8" ? (
          ...
          <div className="space-y-10 text-white/90 text-base md:text-lg leading-relaxed font-medium">
            <motion.div variants={itemVariants} className="border-l-4 border-secondary pl-6">
